...
PROC IMPORT OUT= WORK.SPOT
            DATAFILE= "C:\Users\30970\Desktop\JBAZ_TS_VS_XS\Commodity_SPOT.xlsx"
            DBMS=EXCEL REPLACE ;
GETNAMES=YES;
MIXED=NO;
SCANTEXT=YES;
...
DATA COMPACTDATA3D;
	SET COMPACTDATA3;
	IF CUR="GOLD" THEN IF NAME<"25MAY1976"d THEN DELETE;
	IF CUR="PLATINUM" THEN IF NAME<"20AUG1987"d THEN DELETE;
	IF CUR="PALLADIUM" THEN IF NAME<"23OCT1987"d THEN DELETE;
	IF CUR="COPPER" THEN IF NAME<"30APR1990"d THEN DELETE;
	IF CUR="NICKEL" THEN IF NAME<"23DEC1998"d THEN DELETE;
	IF CUR="SILVER" THEN IF NAME<"25MAY1976"d THEN DELETE;
	IF CUR="ALUMINIUM" THEN IF NAME<"11DEC1998"d THEN DELETE;
	IF CUR="CRUDE" THEN IF NAME<"31AUG1984"d THEN DELETE;
	IF CUR="NATGAS" THEN IF NAME<"19AUG1991"d THEN DELETE;
RUN; 

/* SIGNAL */

DATA ASH.COMPACTDATA3_COMM;
	SET COMPACTDATA3D;
RUN;
